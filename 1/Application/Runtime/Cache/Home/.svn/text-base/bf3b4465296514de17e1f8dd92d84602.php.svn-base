                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-content">
                                <h2>相关搜索结果约&nbsp;<span><?php echo ($count); ?></span>&nbsp;个</h2>

                                <?php if(is_array($article)): foreach($article as $key=>$v): ?><div class="single_item">
                                        <div class="hr-line-dashed"></div>
                                        <div class="search-result">
                                            <h3><a href="<?php echo U('Home/Article/article_detail',array('arid'=>$v['arid']));?>"><?php echo ($v["title"]); ?></a></h3>
                                            <small>
