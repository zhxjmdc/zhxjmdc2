                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example column-table">
                            ...
                            <tbody>
                                <?php if(is_array($article)): foreach($article as $key=>$v): ?><tr>
                                        <td><?php echo ($v["arid"]); ?></td>
                                        <td title="<?php echo ($v["title"]); ?>">
                                            <?php echo mb_substr($v['title'], 0, 15, 'utf-8')?>...
                                        </td>
                                        <td class="table-operate">
                                            <span style="color:#f00" onclick="articleDel(<?php echo ($v["arid"]); ?>)">删除</span>
                                            <span><a href="<?php echo U('Home/Article/article_edit_page',array('arid' => $v['arid']));?>">修改</a></span>
                                            <span><a href="<?php echo U('Home/Article/article_add_page');?>">添加</a></span>
                                            <span onclick="preview(<?php echo ($v["arid"]); ?>)">预览</span>
                                            <span><a href="<?php echo U('Home/Article/article_drafts',array('arid' => $v['arid']));?>">移至草稿箱</a></span>
                                        </td>
                                        <td><?php echo ($v["author"]); ?></td>
                                        <td><?php echo ($v["typename"]); ?></td>
                                        <td>
                                            <?php echo mb_substr($v['describe'], 0, 10, 'utf-8')?>...
                                        </td>
