            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li <?php if((ACTION_NAME) == "share_add_page"): ?>class="active"<?php endif; ?>>
                        <a href="<?php echo U('Home/WechatManage/share_add_page');?>">用户管理</a>
                        </li>
                        <li <?php if((ACTION_NAME) == "share_type_page"): ?>class="active"<?php endif; ?>>
        ...
        <div class="col-lg-12 animated fadeInRight">
            <div class="mail-box-header wechat-source">
                <ul class="nav nav-pills">
                    <li role="presentation"><a href="<?php echo U('Home/WechatManage/image_text_source_page');?>">图文消息</a></li>
                    ...
                    <li role="presentation" class="active"><a href="<?php echo U('Home/WechatManage/video_source_page');?>">视频</a></li>
                </ul>
            </div>
            <div class="mail-box">
                <div class="mail-body">
