                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example column-table">
                            ...
                            <tbody>
                                <?php if(is_array($comment)): foreach($comment as $key=>$v): ?><tr>
                                        ...
                                        <td><?php echo ($v["pcid_comment"]); ?></td>
                                        <td><?php echo date('Y年 n月 j日 H:i',$v['time'])?></td>
                                        <td class="table-operate">
                                            <span style="color:#f00" onclick="commentDel(<?php echo ($v["cid"]); ?>,'new')">删除</span>
                                            <span><a href="<?php echo U('Home/Comment/comment_checked',array('cid'=>$v['cid']));?>">审核通过</a></span>
