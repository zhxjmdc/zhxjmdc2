...
<!-- header -->
            ...
            <div class="wrapper wrapper-content  animated fadeInRight">
                <div class="row">
                    <div class="col-lg-4">
                        <form action="<?php echo U('Home/Article/article_type_add');?>" class="form-horizontal" method="post" enctype="multipart/form-data">
                        <div class="ibox ">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <tbody>
                                        <?php if(is_array($type)): foreach($type as $key=>$v): ?><tr>
                                            <td class="type-img"><img src="<?php echo ($v["img"]); ?>" onerror="this.src='/zhxjmdc/1/Admin/Template/Images/default_img.jpg'"></td>
                                            <td>
                                                <div class="btn-group">
                                                    <button type="button" class="btn"><?php echo ($v["typename"]); ?></button>
                                                    <button type="button" class="btn dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <span class="caret"></span>
                                                    <span class="sr-only">Toggle Dropdown</span>
                                                    </button>
                                                    <ul class="dropdown-menu">
                                                        <li><a href="<?php echo U('Home/Article/article_type_edit_page',array('aid'=>$v['aid']));?>">编辑</a></li>
                                                        <li><a onclick="articleTypeDel(<?php echo ($v["aid"]); ?>)" style="color:#f00;">删除</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                            <td><?php echo ($v["describe"]); ?></td>
                                            <td class="center"><?php echo ($v["alias"]); ?></td>
