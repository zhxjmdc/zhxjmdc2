...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
		<h2>主页</h2>
		<ol class="breadcrumb">
			<li><a href="index.html">救命稻草</a></li>
			...
			<div class="ibox float-e-margins">
				...
				<div>
					...
					<div class="ibox-content profile-content">
						<h4><strong>救命稻草</strong></h4>
						<p><i class="fa fa-map-marker"></i> 浙江省杭州市西湖区</p>
						<h5>关于我</h5>
						<p>
							会web前端Div、Css、Js和后台服务端Php等,热爱生活,喜欢学习新的技术,励志成为一名全栈工程师
						</p>
				...
				<div class="ibox-content">
					<div class="row m-t-lg">
						<div class="col-md-4">
							...
							<h5><strong><?php echo ($article_count); ?></strong> 文章</h5>
						</div>
						<div class="col-md-4">
							<span class="line">5,3,9,6,5,9,7,3,5,2</span>
							<h5><strong><?php echo ($comment_count); ?></strong> 评论</h5>
						</div>
						<div class="col-md-4">
							<span class="bar">5,3,2,-1,-3,-2,2,3,5,2</span>
							<h5><strong><?php echo ($browse_count); ?></strong> 浏览</h5>
						</div>
					</div>
				</div>
			</div>
