...
<script>
    ...
    var zNodes =[
        { id:1, pId:0, name:"展开、折叠 自定义图标不同", open:true, iconOpen:"/zhxjmdc/1/Admin/Template/Css/plugins/z-tree/img/diy/1_open.png", iconClose:"../../../css/zTreeStyle/img/diy/1_close.png"},
        { id:11, pId:1, name:"叶子节点1", icon:"/zhxjmdc/1/Admin/Template/Css/plugins/z-tree/img/diy/2.png"},
        { id:12, pId:1, name:"叶子节点2", icon:"/zhxjmdc/1/Admin/Template/Css/plugins/z-tree/img/diy/3.png"},
        { id:13, pId:1, name:"叶子节点3", icon:"/zhxjmdc/1/Admin/Template/Css/plugins/z-tree/img/diy/5.png"},
        { id:2, pId:0, name:"展开、折叠 自定义图标相同", open:true, icon:"/zhxjmdc/1/Admin/Template/Css/plugins/z-tree/img/diy/4.png"},
        { id:21, pId:2, name:"叶子节点1", icon:"/zhxjmdc/1/Admin/Template/Css/plugins/z-tree/img/diy/6.png"},
        { id:22, pId:2, name:"叶子节点2", icon:"/zhxjmdc/1/Admin/Template/Css/plugins/z-tree/img/diy/7.png"},
        { id:23, pId:2, name:"叶子节点3", icon:"/zhxjmdc/1/Admin/Template/Css/plugins/z-tree/img/diy/8.png"},
    ...
    function getData(page) { //获取当前页数据
        $.ajax({
            url     : "<?php echo U('Home/WechatManage/get_user_list');?>",
            type    : 'post',
            data    : {'page': page - 1},
            success : function(json){
                ...
                $.each(list, function(index, array) { //遍历返回json
                    li += '<li class="feed-element"><img alt="image" class="img-circle pull-left" src="'+array['headimgurl']+'"><div class="media-body "> <button class="pull-right">'+array['w_uid']+'修改备注</button> <strong><?php echo ($v["nickname"]); ?></strong><br><small class="text-muted">标签</small></div></li>';
                });
                $("#ul_lists").append(li);
            },
            complete: function() {
