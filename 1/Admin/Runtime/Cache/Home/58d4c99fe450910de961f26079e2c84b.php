                    ...
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <ul class="dropdown-menu dropdown-user">
                                <li>
                                    <a onclick="column_order()">更新栏目权重</a>
                                </li>
                            </ul>
                            <a class="close-link">
                            ...
                            <tbody>
                                <?php if(is_array($column)): foreach($column as $key=>$v): ?><tr>
                                        ...
                                        <td class="table-operate">
                                            <span style="color:#f00" onclick="columnDel(<?php echo ($v["cid"]); ?>)">删除</span>
                                            <span>
                                                <a href="<?php echo U('Home/Column/column_edit_page',array('cid' => $v['cid']));?>">修改</a>
                                            </span>
                                            <span>
                                                <a href="<?php echo U('Home/Column/column_add_page');?>">添加</a>
                                            </span>
                                            <span>预览</span>
                                        </td>
                                        <td>
                                            <a id='status<?php echo ($v["cid"]); ?>' onclick="changeStatus(<?php echo ($v["cid"]); ?>)"><?php echo ($v["status"]); ?></a>
                                        </td>
                                        <th><?php echo ($v["type"]); ?></th>
                                        <td class="column-order">
                                            <input type="text" class="form-control" value="<?php echo ($v["column_order"]); ?>" style="max-width:80px;">
                                            <input type="hidden" value="<?php echo ($v["cid"]); ?>">
                                        </td>
